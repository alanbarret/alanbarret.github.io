...
const projects = [
  ...
  {
    name: "Health Kingdom: Telemedicine Platform",
    description: "An embedded systems project for digital healthcare featuring sensor integration (digital stethoscope, IR camera), video conferencing, and a Python Flask backend.",
    image: "https://placehold.co/600x400.png",
    imageHint: "telemedicine doctor patient",
    tags: ["Embedded Systems", "IoT", "Telemedicine", "Python", "Flask"],
    github: "#",
    demo: "#",
  },
  {
